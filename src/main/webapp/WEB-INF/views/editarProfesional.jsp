...
<body>
    <header class="header-2">
        ...
        <form id="formulario" method="post" action="<c:out value="${pageContext.request.contextPath}"/>/procesarEditarProfesional" class="cmxform" id="pagForm">
            
            <h2 id="titulo">Editar Profesional</h2>
            <label for="" id="label">Rut Profesional</label>
            <input type="text" id="input" name="txtrutprofesional" value='<c:out value="${usr.getRun()}"/>' readonly="readonly"/>
            <label for="" id="label">Nombres</label>
            <input type="text" id="input" name="txtpronombres" value='<c:out value="${pro.getNombres()}"/>'/>
            <label for="" id="label">Apellidos</label>
            <input type="text" id="input" name="txtproapellidos" value='<c:out value="${pro.getApellidos()}"/>'/>
            <label for="" id="label">Teléfono</label>
            <input type="text" id="input" name="txtprotelefono" value='<c:out value="${pro.getTelefono()}"/>'/>
            <label for="" id="label">Título profesional</label>
            <input type="text" id="input" name="txtprotitulo" value='<c:out value="${pro.getTituloprofesional()}"/>'/>
            <label for="" id="label">Proyecto</label>
            <input type="text" id="input" name="txtproproyecto" value='<c:out value="${pro.getProyecto()}"/>'/>
            <label for="" id="label">RUT</label>
            <input type="text" id="input" name="txtusuariorun" value='<c:out value="${usr.getRun()}"/>' readonly="readonly"/>
			<input type="submit" id="boton" value="Editar Profesional">
