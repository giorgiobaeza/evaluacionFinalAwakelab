...
<body>
    ...
    <div class="contenedor">
        <form id="formulario" method="post" action="<c:out value="${pageContext.request.contextPath}"/>/procesarEditarAdministrativo" class="cmxform">
            
            <h2 id="titulo">Editar Administrativo</h2>
            <label for="" id="label">Rut Administrativo</label>
            <input type="text" id="input" name="txtrutadministrativo" value='<c:out value="${usr.getRun()}"/>' readonly="readonly"/>
            <label for="" id="label">Nombres</label>
            <input type="text" id="input" name="txtadmnombres" value='<c:out value="${adm.getNombres()}"/>'/>
            <label for="" id="label">Apellidos</label>
            <input type="text" id="input" name="txtadmapellidos" value='<c:out value="${adm.getApellidos()}"/>'/>
            <label for="" id="label">Email</label>
            <input type="text" id="input" name="txtadmemail" value='<c:out value="${adm.getEmail()}"/>'/>
            <label for="" id="label">Sistema de Salud</label>
            <input type="text" id="input" name="txtadmarea" value='<c:out value="${adm.getArea()}"/>'/>
			<input style="display:none" type="text" name="txtusuariorun" value='<c:out value="${usr.getRun()}"/>' readonly="readonly"/>
            <input type="submit" id="boton" value="Editar Administrativo">
        </form>
    </div>
    <footer>
        <div class="siguenos">
